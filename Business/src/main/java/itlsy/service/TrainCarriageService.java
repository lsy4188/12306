...
import itlsy.mapper.TrainCarriageMapper;
import itlsy.req.TrainCarriageQueryReq;
import itlsy.req.TrainCarriageSaveReq;
import itlsy.resp.PageResp;
import itlsy.resp.TrainCarriageQueryResp;
...
public class TrainCarriageService {
    ...
    public PageResp<TrainCarriageQueryResp> queryList(TrainCarriageQueryReq req) {
        ...
        if (ObjectUtil.isNotEmpty(req.getTrainCode())) {
            trainCarriageExample.createCriteria().andTrainCodeEqualTo(req.getTrainCode());
        }
